...
$string['generatingstale'] = 'Dies wartet nun seit {$a} in der Warteschlange, ohne abgeschlossen zu sein. Das ist länger, als jede echte Hintergrundberechnung auf dieser Website bisher gedauert hat; höchstwahrscheinlich läuft Moodles Cron nicht, die Hintergrundaufgabe ist abgestürzt oder hat den Speicher überschritten, oder Cron hängt hinter einer anderen, unabhängigen Aufgabe fest, die ständig fehlschlägt und erneut versucht wird. Bitten Sie Ihre Moodle-Administration, unter Website-Administration → Server → Geplante Aufgaben (läuft Cron überhaupt?) und Website-Administration → Server → Aufgaben → Aufgabenprotokolle nachzusehen — ob diese Aufgabe fehlgeschlagen ist, aber auch ob eine ganz andere Aufgabe immer wieder fehlschlägt und dadurch jeden Cron-Lauf blockiert, obwohl an dieser Stelle eigentlich nichts kaputt ist — statt länger zu warten.';
