...
$string['generatingstale'] = 'Questo elemento è in coda da {$a} senza essere completato. È più tempo di quanto abbia mai richiesto un calcolo in background reale su questo sito, quindi molto probabilmente significa che il cron di Moodle non è in esecuzione, che l\'attività in background è andata in crash o ha esaurito la memoria, oppure che il cron è bloccato dietro un\'altra attività, non correlata, che continua a fallire e a essere ritentata. Chiedi al tuo amministratore di Moodle di controllare Amministrazione del sito → Server → Attività pianificate (il cron è effettivamente in esecuzione?) e Amministrazione del sito → Server → Attività → Log delle attività — sia per verificare se questa attività è fallita, sia per controllare se un\'attività completamente diversa sta fallendo ripetutamente, il che può occupare ogni esecuzione del cron e affamare questa attività anche se qui non c\'è in realtà nulla di rotto — invece di attendere ulteriormente.';
